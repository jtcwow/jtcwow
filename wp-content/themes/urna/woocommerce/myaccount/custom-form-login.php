<?php 
    ...
    if( !(defined('URNA_WOOCOMMERCE_ACTIVED') && URNA_WOOCOMMERCE_ACTIVED) || is_user_logged_in() || !$show_login || !$show_login_popup ) return;
                ...
                <div class="tab-content clearfix">
                    <div id="tab-customlogin" class="tab-pane fade in active">
                        <form id="custom-login" class="ajax-auth" action="login" method="post">
                            ...
                            <input class="submit_button" type="submit" value="<?php esc_html_e('Login', 'urna'); ?>">
                    ...
                    <div id="tab-customregister" class="tab-pane fade">
                        <form id="custom-register" class="ajax-auth"  action="register" method="post">
                            ...
                            <input class="submit_button" type="submit" value="<?php esc_html_e('Register', 'urna'); ?>">
