...
function urna_tbay_get_load_plugins() {
	...
	$plugins[] =(array(
	    ...
	    'slug'                     => 'js_composer',
	    'required'                 => true,
	    'source'         		   => esc_url( 'bitbucket.org/devthembay/plugins/raw/master/js_composer.zip' ),
	));
	...
	$plugins[] =(array(
		...
		'slug'                     => 'urna-core',
		'required'                 => true ,
		'source'         		   => esc_url( 'bitbucket.org/devthembay/plugins/raw/master/urna-core.zip' ),
	));
	...
	$plugins[] =(array(
	    ...
	    'required'                 =>  true,
	    'source'         		   => esc_url( 'bitbucket.org/devthembay/plugins/raw/master/woocommerce-products-filter.zip' ),
	));	
	...
	$plugins[] =(array(
        ...
        'slug'                     => 'revslider',
        'required'                 => true ,
        'source'         		   => esc_url( 'bitbucket.org/devthembay/plugins/raw/master/revslider.zip' ),
	));
...
if ( !function_exists('tbay_dokan_theme_store_sidebar') ) {
    function tbay_dokan_theme_store_sidebar() {
