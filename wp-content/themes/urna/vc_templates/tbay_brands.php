...
<div class="<?php echo esc_attr($css_class); ?>">
    ...
    <div class="tbay-addon-content">
    	<?php if ( $loop->have_posts() ): ?>
    		...
    		?>	
			<div class="owl-carousel brands rows-<?php echo esc_attr( $rows_count ); ?> <?php echo esc_attr( $class_item ); ?>" <?php echo trim($responsive_carousel); ?>  <?php echo trim($data_carousel); ?> >
			    <?php $count = 0; while ( $loop->have_posts() ): $loop->the_post(); ?>
						...
						<div class="item">
			                ...
			                ?>
							<a href="<?php echo esc_url($link); ?>" target="<?php echo esc_attr($onclick); ?>" class="tbay-image-loaded"> 
								<?php echo urna_tbay_get_attachment_image_loaded($post_thumbnail_id, 'thumbnail'); ?>
							</a>
						</div>
