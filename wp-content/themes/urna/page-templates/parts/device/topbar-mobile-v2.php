<?php   
	...
	if( !$always_display_logo && !urna_catalog_mode_active() && defined('URNA_WOOCOMMERCE_ACTIVED') && (is_product() || is_cart() || is_checkout()) ) {
		$class_top_bar .= ' active-home-icon';
	}
?>
<div class="topbar-device-mobile hidden-md hidden-lg clearfix <?php echo esc_attr( $class_top_bar ); ?>">
