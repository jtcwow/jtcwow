...
<form id="dokan-vendor-register" method="post" class="register dokan-vendor-register">
    ...
    <div class="split-row name-field form-row-wide">
        <p class="form-row form-group">
            <label for="first-name"><?php esc_html_e( 'First Name', 'urna' ); ?> <span class="required">*</span></label>
        ...
        <p class="form-row form-group">
            <label for="last-name"><?php esc_html_e( 'Last Name', 'urna' ); ?> <span class="required">*</span></label>
    ...
    <?php if ( 'no' === get_option( 'woocommerce_registration_generate_username' ) ) : ?>
        <p class="form-row form-group form-row-wide">
            <label for="reg_username"><?php esc_html_e( 'Username', 'urna' ); ?> <span class="required">*</span></label>
    ...
    <p class="form-row form-group form-row-wide">
        <label for="reg_email"><?php esc_html_e( 'Email address', 'urna' ); ?> <span class="required">*</span></label>
    ...
    <p class="form-row form-group form-row-wide">
        <label for="shop-phone"><?php esc_html_e( 'Phone Number', 'urna' ); ?><span class="required">*</span></label>
    ...
    <p class="form-row form-group form-row-wide">
        <label for="reg_password"><?php esc_html_e( 'Password', 'urna' ); ?> <span class="required">*</span></label>
    ...
    <!-- Spam Trap -->
    <div style="left:-999em; position:absolute;"><label for="trap"><?php esc_html_e( 'Anti-spam', 'urna' ); ?></label><input type="text" name="email_2" id="trap" tabindex="-1" /></div>

    <p class="form-row form-group form-row-wide">
        <label for="company-name"><?php esc_html_e( 'Shop Name', 'urna' ); ?> <span class="required">*</span></label>
    ...
    <p class="form-row form-group form-row-wide">
        <label for="seller-url" class="pull-left"><?php esc_html_e( 'Shop URL', 'urna' ); ?> <span class="required">*</span></label>
    ...
    if ( 'on' === $show_terms_condition && $terms_condition_url ) { ?>
        <p class="form-row form-group form-row-wide">
            ...
            <label style="display: inline" for="tc_agree"><?php echo sprintf( __( 'I have read and agree to the <a target="_blank" href="%s">Terms &amp; Conditions</a>.', 'urna' ), esc_url( $terms_condition_url ) ); // phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped  ?></label>
        </p>
    <?php }
    ...
    <p class="form-row">
        ...
        <input type="submit" class="dokan-btn dokan-btn-theme" name="register" value="<?php esc_attr_e( 'Register', 'urna' ); ?>" />
    </p>
