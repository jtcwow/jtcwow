...
$main_font_skin 	= '.btn';
$main_color_skin 	= '.has-after:hover,button.btn-close:hover,.new-input + span:before,.new-input + label:before,.tbay-addon-features .inner .ourservice-heading:hover,.sidebar-content-wrapper .language-sidebar a:hover,#tbay-search-form-canvas.v4 button:hover,#tbay-search-form-canvas.v4 button:hover i,#tbay-search-form-canvas.v4 .sidebar-canvas-search .sidebar-content .select-category .optWrapper .options li:hover label , #tbay-search-form-canvas.v4 .autocomplete-suggestions > div .suggestion-group:hover .suggestion-title';  
$main_bg_skin 		= '.has-after:after , .btn-theme-2 ';
$main_border_skin 	= '.btn-theme-2';
$main_border_top_skin 	= '#tbay-search-form-canvas.v4 .tbay-loading:after, .tbay-loading:after';
