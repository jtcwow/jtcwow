...
if ( !function_exists ('urna_tbay_skin_custom_styles') ) {
	function urna_tbay_skin_custom_styles() {
		...
		$main_skin_black = ', .mobile-btn-cart-click #tbay-click-buy-now, #shop-now.has-buy-now .tbay-buy-now.button:not(.disabled):hover, #shop-now.has-buy-now .tbay-buy-now.button:not(.disabled):focus, body table.compare-list .add-to-cart td a.button';
