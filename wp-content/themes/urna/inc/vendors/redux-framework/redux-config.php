...
if (!class_exists('Urna_Redux_Framework_Config')) {
    ...
    class Urna_Redux_Framework_Config
    {
        ...
        public function redux_output() 
        {
            ...
            if( !isset($this->output['secondary-font']) ) {
                $this->output['secondary-font'] = '';
            }
        }        
        ...
        public function redux_default_color() 
        {
            ...
            if( !isset($this->default_color['font_family_second']) ) {
                $this->default_color['font_family_second'] = false;
            }
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'type'          => 'switch',
                        'title'         => esc_html__('Lazy-Load-Image', 'urna'),
                        'default'       => true
                    ),
                )
            );
            ...
            $this->sections[] = array(
                ...
                'fields' => array(                
                    ...
                    array(
                        ...
                        'required' => array('mobile_footer_menu_order','=', true),
                        'desc'       => sprintf( 
                            wp_kses( __( 'Enter icon name of fonts: <a href="%s" target="_blank">Awesome</a> and <a href="%s" target="_blank">Materialdesigniconic</a> and <a href="%s" target="_blank">Simplelineicons</a> and <a href="%s" target="_blank">Linearicons</a> .  <a href="%s" target="_blank">How to use?</a> ', 'urna' ), 
                                array(  
                                    'a' => array( 'href' => array() ), 
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array (
                        ...
                        'output' => $output['main_color_third'],
                    ),
                )
            );
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array (
                        ...
                        'required' => array(
                            array('show_typography','=', true),
                            array('show_typography','=', $default_color['font_family_second'])
                        )
                    ),
