...
if( !urna_is_woo_variation_swatches_pro() ) return;
...
if ( ! function_exists( 'urna_variation_swatches_pro_group_button' ) ) {
    function urna_variation_swatches_pro_group_button() {
        ...
        if( !apply_filters( 'urna_quantity_mode', 10,2 ) ) echo '<div class="'. esc_attr($class_active) .'">';
        ...
        if( !apply_filters( 'urna_quantity_mode', 10,2 ) ) echo '</div>';
    }
