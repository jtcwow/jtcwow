            ...
            <tbody>
                ...
                <tr valign="top" class="wmc-optional <?php echo $class;?>">
                         ...
                         <td class="forminp">
                            <div class="bonus_for_all <?php echo $customerBonus ? 'wmc-hide' : ''; ?>">
                                <input type="number" max="100" step="0.01" min="0" name="wmc-level-c" id="wmc-level-c" class="form-field" value="<?php echo $customerCredits;?>"><span class="<?php echo $credit_type_class; ?>"> % </span>
                            </div>
                            <table class="form-table wmc-customer-bonus-table bonus_for_customer <?php echo $customerBonus ? '' : 'wmc-hide'; ?>">
                                ...
                                <tr>
                                    <td>
                                        <input type="number" max="100" step="0.01" min="0" name="wmc-level-c-with-link" id="wmc-level-c-with-link" class="form-field" value="<?php echo $customerCredits;?>"><span class="<?php echo $credit_type_class; ?>"> % </span>
                                    </td>
                                    <td>
                                        <input type="number" max="100" step="0.01" min="0" name="wmc-level-c-without-link" id="wmc-level-c-without-link" class="form-field" value="<?php echo $customerCreditsNew;?>"><span class="<?php echo $credit_type_class; ?>"> % </span>
                                    </td>
                                </tr>
                            </table>
                ...
                <?php for($i=0;$i<$maxLevels;$i++){?>
                    <tr valign="top" data-level="<?php echo $i+1;?>" class="wmc-optional wmc-level <?php echo $class;?>">
                         ...
                         <td class="forminp">
                            <input type="number" max="100" step="0.01" min="0" name="wmc-level-credit[]" id="wmc-level-<?php echo $i+1;?>" class="form-field" value="<?php echo $maxLevelCredits[$i];?>"><span class="<?php echo $credit_type_class; ?>"> % </span>
                         </td>      
                    </tr>
                <?php }?>
            </tbody>
