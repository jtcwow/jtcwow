...
define( 'URNA_CORE_VERSION', '1.3.4');
...
$myUpdateChecker = Puc_v4_Factory::buildUpdateChecker(
	'https://plugins.thembay.com/update/urna-core/plugin.json',
 ...
 * 
 */
// require_once( URNA_CORE_DIR . 'libs/promo/urna-promo.php' );
 ...
 *
 */
if ( !function_exists('urna_core_import_init') ) {
	function urna_core_import_init() {
		require URNA_CORE_DIR . 'importer/import.php';
	}
	add_action( 'init', 'urna_core_import_init', 50 );
}
/**
 * functions
 *
